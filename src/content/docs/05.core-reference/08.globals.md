...
Together with `_baseline`, `_pageContext`, and `_snapshot`, that is eight reserved keys. The full list lives in `INTERNAL_KEYS` in the entry point. See [[internals | Internals]].
