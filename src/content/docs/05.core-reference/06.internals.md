...
Of those, three are actually populated today (`_baseline`, `_pageContext`, `_snapshot`); the other five are reserved-but-empty. See [[globals | Globals]] for what's populated and where.
