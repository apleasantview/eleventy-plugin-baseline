...
Directory-based multilingual support: per-language collections, translation mapping, hreflang, and translation filters. Sitemaps come per language, with an index on top.
