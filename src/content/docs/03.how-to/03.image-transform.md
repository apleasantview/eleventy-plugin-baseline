...
- Eleventy 3.x, or a stable 4.x, and `@11ty/eleventy-img` installed.
...
## Make sure `@11ty/eleventy-img` is present
...
## Enable the HTML transform in `eleventy.config.js`
