...
title: 'Page context'
slug: 'page-context'
permalink: '/docs/reference/page-context/'
...
- **In `_snapshot`**: every built page-context lives under `_snapshot.pageContext`, keyed by URL. See [Globals](/docs/reference/globals/).
