...
The overlap is why this guide is shaped the way it is. Most of the conversion is renaming. You are not replacing the starter's thinking so much as moving it onto conventions that already match, then handing over the parts a plugin can keep up to date for you.

The longest chapters are about conventions rather than the ones about the plugin, and that is the shared ground showing. Where the two disagree the guide says so. And there is more to say about where files sit and what they are called than about the thing that reads them.
