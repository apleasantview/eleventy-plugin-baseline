...
- The [conventions page](/docs/introduction/conventions/) for the practical rules of the road: project shape, settings, env vars, and the seams Baseline expects to own.
- The [simple-site tutorial](/docs/tutorial/simple-baseline-site/) for a guided walk through the same checklist with reasoning.
- The [architecture snapshot](/docs/reference/architecture-snapshot/) for a deeper look at the three layers if you want it.
