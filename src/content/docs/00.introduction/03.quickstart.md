...
The minimum working setup. A checklist; for a guided walk with reasoning, see the [[simple-baseline-site]] tutorial.
...
- For multilingual: see the [[multilingual-baseline-site]] tutorial. Activation requires three things together: `options.multilingual: true`, `settings.defaultLanguage`, and a non-empty `settings.languages` map.
