...
title: 'Concepts'
slug: 'concepts'
permalink: '/docs/introduction/concepts/'
...
- The [architecture snapshot](/docs/introduction/architecture-snapshot/) for the deeper model behind the plugin: state, runtime, modules.
