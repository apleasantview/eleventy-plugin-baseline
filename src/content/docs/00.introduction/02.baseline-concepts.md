...
- **Sitemap**
  ...
  `sitemap-core` generates XML sitemaps using `site.url` and page data. Every page is included unless you exclude it.

- **Multilingual (optional)**

  `multilang-core` adds translations collections, i18n filters, and per-language sitemaps with hreflang.
