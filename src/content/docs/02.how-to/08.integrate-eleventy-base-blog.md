...
A completed integration of `eleventy-base-blog` and Baseline is [available on Github](https://github.com/apleasantview/eleventy-baseline-blog).
...
2. Make changes and add Baseline to `eleventy.config.js`.
   ...
   View a complete configuration example in the [`eleventy-base-blog` fork](https://github.com/apleasantview/eleventy-baseline-blog/blob/baseline-edition/eleventy.config.js).
