...
description: 'CI checklist for Baseline builds: set URL/pathPrefix envs, clean dist, gate noindex for previews, validate sitemap/canonicals, and publish dist.'
---
