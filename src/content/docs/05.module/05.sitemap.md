...
2. **Resolve language config.** Reads `settings.languages` through [`normalizeLanguageMap`](_baseline/core/utils/normalize-language-map.js), the same helper the multilang module uses.
