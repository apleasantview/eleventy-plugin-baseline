...
Every page receives a computed `_snapshot` of Baseline's runtime stores, with three fields: `contentMap`, `pageContext` and `seoGraph`. Field by field, that is on [[globals | Globals]].
