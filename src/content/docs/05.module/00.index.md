...
slug: 'module'
description: 'The five modules, all wired on install: assets for CSS and JS, head for meta tags and structured data, plus multilang, navigator, and sitemap.'
date: 2026-01-25
...
**[[multilang]]**: language normalisation, per-page `locale`, translation map, and the translation filters. Opt-in.
