...
- **esbuild.** `minify: true`, `target: 'es2020'`. Defaults live in [\_baseline/modules/assets/processors/esbuild-process.js](https://github.com/apleasantview/eleventy-plugin-baseline/blob/main/_baseline/modules/assets/processors/esbuild-process.js).
