...
- **Robots.** Always emitted. An indexable page gets `<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">`; a page carrying `noindex` (its own or `settings.noindex`) gets `<meta name="robots" content="noindex, nofollow">` instead.
