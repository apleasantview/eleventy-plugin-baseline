...
The pattern is to keep structure in a sibling `*.11tydata.js` file and content metadata in the page's front matter. This isn't a Baseline rule. It's a way of using Eleventy's data cascade that scales as your sections grow, and it's the shape the [conventions page](/docs/introduction/conventions/) assumes when it talks about page data.
...
- [[conventions|Conventions]] for the project-shape conventions this pattern slots into.
