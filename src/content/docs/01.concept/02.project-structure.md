...
The folder structure that keeps Baseline out of your way. If you've read the [overview](/docs/introduction/overview/) and the [concepts page](/docs/introduction/concepts/), you already have the shape. This page is the practical companion: where files go, how the call looks, which environment variables matter, and the few seams Baseline expects to own.
