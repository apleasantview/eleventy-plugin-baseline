...
The full option list is on the [[plugin-entrypoint | plugin-entrypoint reference]]; the settings shape is on the [[site-settings | site-settings reference]].
