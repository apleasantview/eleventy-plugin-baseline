...
The head module reads two parts of the `settings` argument. Full shape on [Site settings](/docs/reference/site-settings/).
...
1. **Cascade-time seed build.** The page-context registry composes a seed object per page: `site`, `page`, `entry`, `query`, `meta`, `render`, `head`. See [Page context](/docs/reference/page-context/) for the shape.
...
- [[head-and-hreflang|Tutorial: head and hreflang]]
