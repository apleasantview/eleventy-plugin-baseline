...
- **Runtime stores** - the content map, the translation map, and the graph-built translation index; read by the page-context registry, the head module and wikilinks.
