...
- [[plugin-entrypoint | Plugin entrypoint]] - the other half of the install, and everything the plugin registers.
- [[project-structure | Project structure]] - what the directories are for, once they are set.
- [[deploy-under-a-subpath | Deploy under a subpath]] - `pathPrefix`, the override with the most knock-ons.
- [[wire-in-baseline | Wire in Baseline]] - forwarding the export, in the tutorial.
