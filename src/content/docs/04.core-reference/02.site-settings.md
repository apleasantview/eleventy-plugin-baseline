...
- **description** (`string`)
  - site-wide description. The last rung of the `<meta name="description">` chain, used when a page supplies no `description`, `seo.description` or `excerpt` and has no first paragraph to draw on.
