...
- The natural next chapter is the [assets pipeline tutorial](/docs/tutorial/assets-pipeline/), which adds PostCSS and esbuild entries. After that, the [head and hreflang tutorial](/docs/tutorial/head-and-noindex/) covers what Baseline injects into every page and how to extend it.
