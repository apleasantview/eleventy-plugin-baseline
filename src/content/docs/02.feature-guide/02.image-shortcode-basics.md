...
The site from the [[simple-baseline-site | simple site tutorial]]. `@11ty/eleventy-img` is a peer dependency you installed there; if it is missing, `npm install @11ty/eleventy-img`.
