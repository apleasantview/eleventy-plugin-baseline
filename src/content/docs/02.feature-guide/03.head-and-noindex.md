...
The site from the [[simple-baseline-site | simple site tutorial]], with `settings.url` set. Canonical URLs are the one thing on this page that needs a real origin.
