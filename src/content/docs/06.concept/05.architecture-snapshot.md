...
- **Stores** are the convention for runtime singletons attached to a registry scope (the content-map store, the translation-map store, the translation-index store).
