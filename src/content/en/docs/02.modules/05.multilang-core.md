...
- `defaultLanguage` (string, required): The primary locale used for fallbacks.
- `languages` (array, optional): Not passed to Eleventy; keep for your own metadata if needed.
