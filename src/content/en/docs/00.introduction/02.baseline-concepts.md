...
## Quick start path (conceptual)
1. Add Baseline to Eleventy config.
2. Add `site.js` and `head.js`.
3. Add `<baseline-head>` to your layout.
4. Add assets entries in `src/assets/`.
5. Build and inspect output in `dist/`.
