...
- Per-page `noindex` is not read by sitemap-core; use `sitemap.ignore` or `eleventyExcludeFromCollections` to exclude a page.
- See the “Sitemaps & Drafts” tutorial for end-to-end usage.
- Tutorial: [Sitemaps & Drafts](/docs/tutorials/sitemaps-and-drafts/)
