...
```njk
{% raw %}{% set cssPath = _baseline.assets.input ~ "css/inline-example.css" %}{% endraw %}
{% raw %}{{ cssPath | inlinePostCSS | safe }}{% endraw %}

{% raw %}{% set jsPath  = _baseline.assets.input ~ "js/inline-example.js" %}{% endraw %}
{% raw %}{{ jsPath  | inlineESbuild | safe }}{% endraw %}
```
