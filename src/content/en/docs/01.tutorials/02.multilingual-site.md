...
- `src/content/en/pages/multilang-home.md`:
```md
  ---
...
- `src/content/nl/pages/multilang-home.md`:
  ```md
  ---
  title: "Hallo Baseline"
  description: "Nederlandse home"
  permalink: "/nl/multilang/"
  layout: "layouts/base.njk"
  translationKey: homepage
  ---
...
Tip: Eleventy doesn’t clean `dist/` automatically. If you rerun dev/build, clear `dist/` first (e.g., `npx rimraf dist`).
