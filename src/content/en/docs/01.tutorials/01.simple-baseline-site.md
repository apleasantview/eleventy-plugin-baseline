...
## 2) Install Eleventy and Baseline
```bash
...
export default function (eleventyConfig) {
  // Defaults: multilingual off, sitemap on, navigator template off.
...
export default {
  ...
  url: "http://localhost:8080", // replace with your production URL when deploying
  defaultLanguage: "en",
  noindex: false
};
```
