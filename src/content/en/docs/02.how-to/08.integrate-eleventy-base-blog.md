...
2. Make changes and add Baseline to `eleventy.config.js`.
   ...
   - Remove the watch targets for CSS files and images. Baseline handles this for you.
   - Point CSS and JS bundle config `toFileDirectory` to `assets/css` and `assets/js` respectively.
...
9. Inline CSS includes with the Baseline PostCSS filter.
